...
abstract class BaseItem extends BaseObject  implements Persistent {
	...
	public function setPlaceId($v)
	{
		...
		if ($this->place_id !== $v) {
			$this->place_id = $v;
			$this->modifiedColumns[] = ItemPeer::PLACE_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ItemPeer::PLACE_ID)) $criteria->add(ItemPeer::PLACE_ID, $this->place_id);
	 ...
	 * related MealOrders from storage. If this Item is new, it will return
		...
		if ($this->collMealOrders === null) {
			if ($this->isNew()) {
			   $this->collMealOrders = array();
				...
				$criteria->add(MealOrderPeer::ITEM_ID, $this->id);
