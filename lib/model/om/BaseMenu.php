...
abstract class BaseMenu extends BaseObject  implements Persistent {
	...
	public function setPlaceId($v)
	{
		...
		if ($this->place_id !== $v) {
			$this->place_id = $v;
			$this->modifiedColumns[] = MenuPeer::PLACE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = MenuPeer::NUM_COLUMNS - MenuPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::PLACE_ID)) $criteria->add(MenuPeer::PLACE_ID, $this->place_id);
	 ...
	 * related Items from storage. If this Menu is new, it will return
		...
		if ($this->collItems === null) {
			if ($this->isNew()) {
			   $this->collItems = array();
				...
				$criteria->add(ItemPeer::MENU_ID, $this->id);
