...
abstract class BaseItemPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'MenuId', 'Name', 'Description', 'Price', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'menuId', 'name', 'description', 'price', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::MENU_ID, self::NAME, self::DESCRIPTION, self::PRICE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'menu_id', 'name', 'description', 'price', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MenuId' => 1, 'Name' => 2, 'Description' => 3, 'Price' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'menuId' => 1, 'name' => 2, 'description' => 3, 'price' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MENU_ID => 1, self::NAME => 2, self::DESCRIPTION => 3, self::PRICE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'menu_id' => 1, 'name' => 2, 'description' => 3, 'price' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ItemPeer::MENU_ID);
	...
	public static function doCountJoinMenu(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ItemPeer::MENU_ID, MenuPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Item objects pre-filled with their Menu objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinMenu(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to $obj2 (Menu)
				$obj2->addItem($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to the collection in $obj2 (Menu)
				$obj2->addItem($obj1);
