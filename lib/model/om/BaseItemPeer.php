...
abstract class BaseItemPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PlaceId', 'Name', 'Description', 'Price', 'Image', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'placeId', 'name', 'description', 'price', 'image', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PLACE_ID, self::NAME, self::DESCRIPTION, self::PRICE, self::IMAGE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'place_id', 'name', 'description', 'price', 'image', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PlaceId' => 1, 'Name' => 2, 'Description' => 3, 'Price' => 4, 'Image' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'placeId' => 1, 'name' => 2, 'description' => 3, 'price' => 4, 'image' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PLACE_ID => 1, self::NAME => 2, self::DESCRIPTION => 3, self::PRICE => 4, self::IMAGE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'place_id' => 1, 'name' => 2, 'description' => 3, 'price' => 4, 'image' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ItemPeer::PLACE_ID);
	...
	public static function doCountJoinPlace(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ItemPeer::PLACE_ID, PlacePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Item objects pre-filled with their Place objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPlace(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to $obj2 (Place)
				$obj2->addItem($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to the collection in $obj2 (Place)
				$obj2->addItem($obj1);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(MealOrderPeer::ITEM_ID, $obj->getId());
