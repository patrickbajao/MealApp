...
abstract class BaseItemPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PlaceId', 'Name', 'Description', 'Price', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'placeId', 'name', 'description', 'price', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PLACE_ID, self::NAME, self::DESCRIPTION, self::PRICE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'place_id', 'name', 'description', 'price', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PlaceId' => 1, 'Name' => 2, 'Description' => 3, 'Price' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'placeId' => 1, 'name' => 2, 'description' => 3, 'price' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PLACE_ID => 1, self::NAME => 2, self::DESCRIPTION => 3, self::PRICE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'place_id' => 1, 'name' => 2, 'description' => 3, 'price' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
