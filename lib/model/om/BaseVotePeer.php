...
abstract class BaseVotePeer {
	...
	/** the column name for the MEAL_PLACE_ID field */
	const MEAL_PLACE_ID = 'vote.MEAL_PLACE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'MealPlaceId', 'SfGuardUserId', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mealPlaceId', 'sfGuardUserId', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::MEAL_PLACE_ID, self::SF_GUARD_USER_ID, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'meal_place_id', 'sf_guard_user_id', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MealPlaceId' => 1, 'SfGuardUserId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mealPlaceId' => 1, 'sfGuardUserId' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MEAL_PLACE_ID => 1, self::SF_GUARD_USER_ID => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'meal_place_id' => 1, 'sf_guard_user_id' => 2, 'created_at' => 3, 'updated_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VotePeer::MEAL_PLACE_ID);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related MealPlace table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinMealPlace(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VotePeer::MEAL_PLACE_ID, MealPlacePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Vote objects pre-filled with their MealPlace objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinMealPlace(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = MealPlacePeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = MealPlacePeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					MealPlacePeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (Vote) to $obj2 (MealPlace)
				$obj2->addVote($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		MealPlacePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (MealPlacePeer::NUM_COLUMNS - MealPlacePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined MealPlace rows

			$key2 = MealPlacePeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = MealPlacePeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Vote) to the collection in $obj2 (MealPlace)
				$obj2->addVote($obj1);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptMealPlace(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Vote objects pre-filled with all related objects except MealPlace.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptMealPlace(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
