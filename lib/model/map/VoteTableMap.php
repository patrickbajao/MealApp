...
class VoteTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('MEAL_PLACE_ID', 'MealPlaceId', 'INTEGER', 'meal_place', 'ID', true, null, null);
	...
	{
    $this->addRelation('MealPlace', 'MealPlace', RelationMap::MANY_TO_ONE, array('meal_place_id' => 'id', ), 'CASCADE', null);
