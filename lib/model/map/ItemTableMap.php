...
class ItemTableMap extends TableMap {
	...
	{
    $this->addRelation('Menu', 'Menu', RelationMap::MANY_TO_ONE, array('menu_id' => 'id', ), null, null);
    $this->addRelation('MealOrder', 'MealOrder', RelationMap::ONE_TO_MANY, array('id' => 'item_id', ), null, null);
	} // buildRelations()
