...
class MealTableMap extends TableMap {
    ...
    $this->addRelation('MealOrder', 'MealOrder', RelationMap::ONE_TO_MANY, array('id' => 'meal_id', ), null, null);
    $this->addRelation('Vote', 'Vote', RelationMap::ONE_TO_MANY, array('id' => 'meal_id', ), null, null);
	} // buildRelations()
