...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('MealOrder', 'MealOrder', RelationMap::ONE_TO_MANY, array('id' => 'sf_guard_user_id', ), 'CASCADE', null);
    $this->addRelation('Vote', 'Vote', RelationMap::ONE_TO_MANY, array('id' => 'sf_guard_user_id', ), 'CASCADE', null);
