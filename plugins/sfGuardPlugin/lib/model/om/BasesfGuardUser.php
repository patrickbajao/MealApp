...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	 ...
	 * related MealOrders from storage. If this sfGuardUser is new, it will return
		...
		if ($this->collMealOrders === null) {
			if ($this->isNew()) {
			   $this->collMealOrders = array();
				...
				$criteria->add(MealOrderPeer::SF_GUARD_USER_ID, $this->id);
	 ...
	 */
	public function getMealOrdersJoinMeal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collMealOrders === null) {
			if ($this->isNew()) {
				...
				$this->collMealOrders = MealOrderPeer::doSelectJoinMeal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
		...
		if ($this->collVotes === null) {
			if ($this->isNew()) {
			   $this->collVotes = array();
				...
				$criteria->add(VotePeer::SF_GUARD_USER_ID, $this->id);
