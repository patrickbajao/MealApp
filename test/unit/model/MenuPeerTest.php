...
$meal  = MealPeer::doSelectOne(new Criteria()); //Select the first row in the list of meals
...
$t->is(MenuPeer::getPlaceMenu($meal->getId()), MenuPeer::doSelectOne($c), '::getPlaceMenu() returns the menu of a specific meal');